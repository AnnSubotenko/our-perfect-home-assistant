...
const navItems = [
  ...
  },
  {
    ...
    icon: <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}><path strokeLinecap="round" strokeLinejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>,
  },
  {
    label: "Payments", path: "/payments",
    icon: <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}><path strokeLinecap="round" strokeLinejoin="round" d="M9 7H6a2 2 0 00-2 2v9a2 2 0 002 2h9a2 2 0 002-2v-3M9 7V5a2 2 0 012-2h6l4 4v6a2 2 0 01-2 2h-2M9 7h6" /></svg>,
  },
  {
...
export default function Layout() {
  ...
  return (
    <div className="flex min-h-screen bg-[#f5f4ef]">
      ...
      {/* Sidebar — defined once, shared by all pages */}
      <aside className="w-72 bg-[#2d4a35] flex flex-col py-8 px-5 fixed h-full">
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-colors duration-150 ${
                  isActive ? "bg-[#3d6647] text-white" : "text-[#8aad94] hover:bg-[#3d6647] hover:text-white"
                }`
              }
            >
              {item.icon}
        ...
        <button
          ...
          className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium text-[#8aad94] hover:bg-[#3d6647] hover:text-white transition-colors duration-150"
        >
